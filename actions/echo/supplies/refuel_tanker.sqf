...
if (isNil "ASEC_fnc_ListOfRefuelTanks" || isNil "ASEC_fnc_refuelTanker") then {
	ASEC_fnc_ListOfRefuelTanks = {
		...
		
		{
			...
			_refuelTankerChild pushBack [[
				...
				{_this call ASEC_fnc_refuelTanker},
				{true},
				{},
...
private _refuelTanker = [
	"ASEC_refuelTanker_Option",
	"Refuel From Small Tank", //Get name of classID
	"\A3\ui_f\data\igui\cfg\actions\refuel_ca.paa", //Change images
	{},
	{true},
	{_this call ASEC_fnc_ListOfRefuelTanks},

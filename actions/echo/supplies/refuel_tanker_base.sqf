...
if (isNil "ASEC_fnc_ListOfRefuelTanks_large" || isNil "ASEC_fnc_refuelTanker_large") then {
	ASEC_fnc_ListOfRefuelTanks_large = {
...
private _refuelTanker_large = [
	"ASEC_refuelTanker_Option_large",
	"Full Refuel", //Get name of classID
	"\A3\ui_f\data\igui\cfg\actions\refuel_ca.paa", //Change images
	{},
	{true},
	{_this call ASEC_fnc_ListOfRefuelTanks_large},

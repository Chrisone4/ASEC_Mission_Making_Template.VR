...
if (isNil "ASEC_fnc_ListOfResupplyBoxes" || isNil "ASEC_fnc_resupply") then {
	ASEC_fnc_ListOfResupplyBoxes = {
...
private _resupplyAmmo = [
	"ASEC_resupplyAmmo_Option",
	"Half Resupply", //Get name of classID
	"\A3\ui_f\data\igui\cfg\actions\gear_ca.paa", //Change images
	{},
	{true},
	{_this call ASEC_fnc_ListOfResupplyBoxes},

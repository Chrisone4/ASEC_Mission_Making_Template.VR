...
if (isNil "ASEC_fnc_ListOfResupplyBoxes_large" || isNil "ASEC_fnc_resupply_large") then {
	ASEC_fnc_ListOfResupplyBoxes_large = {
...
private _resupplyAmmo_large = [
	"ASEC_resupplyAmmo_Option_large",
	"Full Resupply", //Get name of classID
	"\A3\ui_f\data\igui\cfg\actions\gear_ca.paa", //Change images
	{},
	{true},
	{_this call ASEC_fnc_ListOfResupplyBoxes_large},

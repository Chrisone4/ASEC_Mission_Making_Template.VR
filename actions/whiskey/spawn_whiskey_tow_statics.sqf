...
#define CRATE_CLASSNAME "Box_IND_WpsSpecial_F"
...
private _crateItems = [
	["ace_compat_rhs_usf3_tow_carry", 2],
	["ace_csw_m220CarryTripod", 2],
	_crate addBackpackCargo	["AMF_TVMMP_weapon", 2], 
	_crate addBackpackCargo	["AMF_MMP_support", 2]
];
